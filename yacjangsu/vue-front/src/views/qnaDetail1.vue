        ...
        <div>
            ...
            <div>
                ...
                <div class="write" v-for="item in content" :key="item.QNA_NO">
                    ...
                    <div class="name"><h4>작성자: {{ content[0].USER_NAME }}</h4></div>
                    ...
                    <div class="btnarea">
                        ...
                        <button type="button" @click="confirmEditContent()" v-else-if="this.user.user_no == this.content[0].USER_NO">수정완료</button>
