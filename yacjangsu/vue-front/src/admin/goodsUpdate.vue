                ...
                <div class="admininfo">
                    <div class="write">
                            ...
                            <div class="container goods_add">
                                <div class="goods_content">
                                    ...
                                    <div class="goodsbox">
                                        ...
                                        <div class="inputRadio">
                                            <label><input type="radio" value="1"
                                                v-model="goods.goods_category">&nbsp;유산균</label>
                                            <label><input type="radio" value="2"
                                                v-model="goods.goods_category">&nbsp;비타민</label>
                                            <label><input type="radio" value="3"
                                                v-model="goods.goods_category">&nbsp;오메가</label>
                                            <label><input type="radio" value="4"
                                                v-model="goods.goods_category">&nbsp;홍삼</label>
                                            <label><input type="radio" value="5"
                                                v-model="goods.goods_category">&nbsp;기타</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="goodsbox" style="margin-left: 150px;">
                                        <img :src="imgSrc" width="200px;" style="border-radius:15px;">
                                    </div>
                                    ...
                                    <div v-if="goods.goods_img" class="goodsbox" style="margin-left: 150px;">
                                        <img :src="require(`../../../node-back/uploads/uploadGoods/` + `${goods.goods_img}`)" alt="상품 이미지" width="100px;" height="150px" style="border-radius:15px;">
                                    </div>
                        ...
                        <div class="btnarea" style="margin-top: 5%;">
                            <button @click="goodsUpdate">수정</button>
                            <button @click="goToList" style=" border: 2px solid black;">취소</button>
                        </div>
                    </div>
                </div>
            </section>
