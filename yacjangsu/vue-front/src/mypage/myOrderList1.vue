                ...
                <tbody>
                  <tr v-for="(order, i) in uniqueOrderList" :key="i">
                    ...
                    <td>
                      ...
                      <a :href="'http://localhost:8080/order/orderDetail/' + order.items[0].ORDERS_NO"
                        class="imgSpace" style="font-size: small; color: #9c0410">
                        주문상세보기 &gt;
                      </a>
                    </td>
                    <td>
                      <button class="rebtn">환불 요청</button>
                      <hr style="margin-bottom: 3px">
                      <button class="rebtn">교환 요청</button>
                      <hr style="margin-bottom: 3px">
                      <button class="rebtn" v-if="order.items[0].REVIEW_CHECK === 0 && order.items[0].ORDERS_STATUS === 2"
                        @click="orderConfirm(order.items[0].ORDERS_NO)">구매 확정</button>
                      <button class="rebtn" @click="goToWrite(order.items[0].ORDERS_NO)"
                        v-if="order.items[0].REVIEW_CHECK === 0 && order.items[0].ORDERS_STATUS === 3">리뷰 작성</button>
                    </td>
                  </tr>
                  <tr></tr>
                  <tr></tr>
